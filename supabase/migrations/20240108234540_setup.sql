...
AS $$
DECLARE
  project_url TEXT := 'https://ojcsnyqbpvngnbbqmgsh.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9qY3NueXFicHZuZ25iYnFtZ3NoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0Mzk1Mzg0NywiZXhwIjoyMDU5NTI5ODQ3fQ.xjiR7YwjSuyuHCWuHGX8xkj9hGK6OUfz9k-CrDmcCWA'; -- full access needed for http request to storage
